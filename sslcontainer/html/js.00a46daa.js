...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"js/Storage.js":[function(require,module,exports) {
"use strict";
...
},{}],"node_modules/core-js/modules/_keyof.js":[function(require,module,exports) {
var getKeys = require('./_object-keys');
var toIObject = require('./_to-iobject');
...
},{"./_iter-define":"node_modules/core-js/modules/_iter-define.js"}],"node_modules/core-js/modules/core.string.escape-html.js":[function(require,module,exports) {
'use strict';
var $export = require('./_export');
var $re = require('./_replacer')(/[&<>"']/g, {
  '&': '&amp;',
...
function ColorPicker() {
  (0, _Modules.updateInfoDIV)("starting pixel scanner"); //gets the animation frame

  var timerID;

  var scannerLoop = function scannerLoop() {
    var matrixGridLocArray = Storage.matrixGridLocArray; // empty color array

    var scannedColorsArray = []; // read all pixels from canvas

    var vidCanvas2dContext = Storage.camCanvas.getContext("2d");
    var canvasPixels = vidCanvas2dContext.getImageData(0, 0, window.innerWidth, window.innerHeight); //get the pixels

    var canvasData = canvasPixels.data;

    for (var i = 0; i < matrixGridLocArray.length; i++) {
      var pixLoc = (matrixGridLocArray[i][1] * innerWidth + matrixGridLocArray[i][0]) * 4; // sample and push to array 3 pixels around to get better recognition

      scannedColorsArray.push( //pixel before
      [canvasData[pixLoc - 4], canvasData[pixLoc - 3], canvasData[pixLoc - 2], //this  pixel
      canvasData[pixLoc], canvasData[pixLoc + 1], canvasData[pixLoc + 2], //next pixel
      canvasData[pixLoc + 4], canvasData[pixLoc + 5], canvasData[pixLoc + 6]]);
    } // call the CV method for color analysis


    CV(scannedColorsArray); //recursively call this method every frame
...
function CV(scannedPixels) {
  ...
  var threshold = 5;
  var avg, avg_0, avg_1, avg_2, pixelCol; //reset array

  var pixelColorArray = []; //sample 3 pixels [3x3 colors] each time

  for (var i = 0; i < scannedPixels.length; i++) {
    ...
    avg = (avg_0 + avg_1 + avg_2) / 3; // decide if pixel color should be black or white
    //based on avg function

    if (avg > 85 + threshold) {
      //black
      pixelCol = 0; //} else if (avg < 256 / 2 - threshold) {
...
function typesLookup() {
  ...
  if (JSON.stringify(Storage.old_pixel_Col_Array) !== JSON.stringify(Storage.pixelColArr)) {
    Storage.old_pixel_Col_Array = Storage.pixelColArr; //get pixels colors array from storage

    var pixelColorArray = Storage.old_pixel_Col_Array;
    var typesArray = [];

    for (var i = 0; i < pixelColorArray.length; i = i + 16) {
      var thisBrick = [];
      ...
      thisBrick = thisBrick.join(""); //look for this bricks pattern in 'Codes' prop

      var indexCode = Storage.cityIOdataStruct.objects.codes.indexOf(thisBrick);
      typesArray.push(indexCode);
    } //save types array to global storage


    Storage.typesArray = typesArray; //if no new colors array exist, skip this method
  } else {
    return;
  }
}
},{"../Storage":"js/Storage.js","../Modules":"js/Modules.js"}],"node_modules/perspective-transform/dist/perspective-transform.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{}],"js/CV/MatrixTransform.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.scanArrayMaker = scanArrayMaker;
exports.MatrixTransform = MatrixTransform;
exports.drawPnt = drawPnt;
...
function scanArrayMaker() {
  var cityIOdataStruct = Storage.cityIOdataStruct; //get the camera canvas

  var camCanvas = Storage.camCanvas; //amount of grid pixels from settings JSON

  var gridCols = cityIOdataStruct.header.spatial.ncols * 4;
  var gridRows = cityIOdataStruct.header.spatial.nrows * 4; //init the array

  var initialScannerGridArr = []; //get canvas ratio to divided by #-1 of points

  var ratX = camCanvas.width / (gridCols - 1);
  var ratY = camCanvas.height / (gridRows - 1); //outer two loops create the rows and cols of each brick

  for (var outCols = 0; outCols < camCanvas.height; outCols += ratY * 4) {
    for (var outRows = camCanvas.width; outRows > 0; outRows -= ratX * 4) {
      //inner loops create the 4x4 points of the brick itself
      for (var inCols = 0; inCols <= ratY * 3; inCols += ratY * 0.95) {
        for (var inRows = 0; inRows <= ratX * 3; inRows += ratX * 0.95) {
...
var colorPicker = new _CV.ColorPicker(); //create the scanning transposed matrix

function MatrixTransform(gridCorners) {
  //get canvas from Storage
  var camCanvas = Storage.camCanvas; // returns a new baseline grid of locations as Array

  var initialScannerGridArr = Storage.initialScannerGridArr; //matrix Grid Location Array

  var matrixGridLocArray = []; //set the reference points of the 4 edges of the canvas
  // to get 100% of the image/video in canvas
  //before distorting

  var srcCorners = [getPos(camCanvas)[0], getPos(camCanvas)[1], camCanvas.width, getPos(camCanvas)[1], getPos(camCanvas)[0], camCanvas.height, camCanvas.width, camCanvas.height]; //var for the distorted points

  var dstPt; // use perspT lib to calculate transform matrix
  //and store the results of the 4 points dist. in var perspT

  var perspTres;
  perspTres = PerspT(srcCorners, gridCorners);
  var svgPntsArray = [];
  var svgKeystone = document.querySelector("#svgKeystone"); // clear SVG at start

  svgKeystone.innerHTML = ""; //distort each dot in the matrix to locations and make cubes

  for (var i = 0; i < initialScannerGridArr.length; i++) {
    /*
    drawPnt(
    ...
    */
    dstPt = perspTres.transform(initialScannerGridArr[i][0], initialScannerGridArr[i][1]); // Draw the grid pnt and put it in an array

    svgPntsArray.push(drawPnt(dstPt, "magenta", i)); //push these locs to an array for scanning

    matrixGridLocArray.push([Math.floor(dstPt[0]), Math.floor(dstPt[1])]);
  } //save to Storage class


  Storage.svgPntsArray = svgPntsArray; //save points to Storage

  Storage.matrixGridLocArray = matrixGridLocArray;
  (0, _Modules.updateInfoDIV)("Matrix Transformed 4 corners are at: " + gridCorners); //start picking colors

  colorPicker.cancel();
  colorPicker.start(); //reset the base corners
...
function getPos(divPos) {
  // yay readability
  for (var lx = 0, ly = 0; divPos != null; lx += divPos.offsetLeft, ly += divPos.offsetTop, divPos = divPos.offsetParent) {
    ;
  }
...
function drawPnt(dstPt, color, text) {
  //show points' text
  // svgKeystone.appendChild(svgText(dstPt, text, 6));
  //create visuals points on canvas for ref and add to array
  var thisPnt = svgKeystone.appendChild((0, _Modules.svgCircle)(dstPt, color, 1.5, 0.5, "#000000", 0.3));
  return thisPnt;
  /*  
...
},{"../Storage":"js/Storage.js","core-js":"node_modules/core-js/index.js","./CV":"js/CV/CV.js","perspective-transform/dist/perspective-transform":"node_modules/perspective-transform/dist/perspective-transform.js","../Modules":"js/Modules.js"}],"js/UI/KeyStoneUI.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.keystoneMouse = keystoneMouse;
exports.keystoneKeys = keystoneKeys;

require("../Storage");

var _Modules = require("../Modules");

var _MatrixTransform = require("../CV/MatrixTransform");

//initial keystone using mouse
function keystoneMouse() {
  var camCanvas = Storage.camCanvas;
  document.body.style.cursor = "crosshair";
  (0, _Modules.updateInfoDIV)("Key-stone in this order: TOP-LEFT [⬉] TOP-RIGHT [⬈] BOTTOM-LEFT  [⬋]  BOTTOM-RIGHT [⬊]"); //

  var svgKeystone = window.svgKeystone; //clear clicks array

  var clkArr = []; //collect 4 mouse clicks as corners of keystone

  document.addEventListener("click", mouseKeystone); // react to mouse events
  ...
  function mouseKeystone(e) {
    ...
    if (e.x < camCanvas.width && e.y < camCanvas.height) {
      //pop. array of clicks
      clkArr.push(e.x, e.y);
      (0, _Modules.updateInfoDIV)("Mouse click " + clkArr.length / 2 + " at " + e.x + ", " + e.y); //show points with svg

      svgKeystone.appendChild((0, _Modules.svgCircle)([e.x, e.y], "none", 10, 0, "magenta", "1")); // when 2x4 clicks were added

      if (clkArr.length == 8) {
        //save these settings for next load
        (0, _Modules.saveSettings)("CityScopeJS_keystone", clkArr); //call the matrix transform function

        (0, _MatrixTransform.MatrixTransform)((0, _Modules.loadSettings)("CityScopeJS_keystone")); // and stop keystone mouse clicks
...
function keystoneKeys() {
  window.addEventListener("keydown", function (event) {
    var key = event.key;
    var keystone = (0, _Modules.loadSettings)("CityScopeJS_keystone");
    keystoneUsingKeys(key, keystone);
  });
  var kyStArrPos = 0; //set the edit speed

  var velocity = 1; // "ArrowRight", "ArrowLeft", "ArrowUp", or "ArrowDown"

  function keystoneUsingKeys(key, keystone) {
    switch (key) {
      case "=":
        velocity += 1;
        (0, _Modules.updateInfoDIV)("edit speed " + velocity.toString() + " pixels at the time");
        break;
      ...
      case "ArrowLeft":
        ...
        (0, _Modules.saveSettings)("CityScopeJS_keystone", keystone);
        (0, _MatrixTransform.MatrixTransform)(keystone);
        break;
      ...
      case "ArrowUp":
        ...
        (0, _Modules.saveSettings)("CityScopeJS_keystone", keystone);
        (0, _MatrixTransform.MatrixTransform)(keystone); // Up pressed
...
},{"../Storage":"js/Storage.js","../Modules":"js/Modules.js","../CV/MatrixTransform":"js/CV/MatrixTransform.js"}],"js/Modules.js":[function(require,module,exports) {
"use strict";
...
exports.stats = stats;
exports.makeInfoDiv = makeInfoDiv;
exports.loadImg = loadImg;
exports.setupWebCamCanvas = setupWebCamCanvas;
exports.setupWebcam = setupWebcam;
exports.makeInfoDIV = makeInfoDIV;
exports.updateInfoDIV = updateInfoDIV;
exports.cityIOinit = cityIOinit;
exports.cityIOstop = cityIOstop;
exports.loadSettings = exports.saveSettings = void 0;

var _KeyStoneUI = require("./UI/KeyStoneUI");
...
function onFileLoad(loadEvent) {
  ...
  reader.onload = function (e) {
    res = e.target.result; //store cityIOdataStruct in Storage

    var cityIOdataStruct = JSON.parse(res); // convert table name to lower text

    cityIOdataStruct.header.name = cityIOdataStruct.header.name.toString().toLowerCase(); //save settings file data into a local Storage location
...
function initSequence() {
  ...
  if (loadSettings("CityScopeJS_keystone")) {
    updateInfoDIV("found key stoning setup...Loading last key stone"); //make the initial grid

    (0, _MatrixTransform.scanArrayMaker)(); // start the matrix transform with the keystone

    (0, _MatrixTransform.MatrixTransform)(loadSettings("CityScopeJS_keystone")); //call the keystoning keyboard function

    (0, _KeyStoneUI.keystoneKeys)();
  } else {
    updateInfoDIV("no keystone was found, starting new one.."); //make the initial grid

    (0, _MatrixTransform.scanArrayMaker)(); //save these keystone points to local storage

    (0, _KeyStoneUI.keystoneMouse)();
  }
} ////////////////////////////////////////////////////////////////////////////////////////////////////////


var saveSettings = function saveSettings(key, data) {
  updateInfoDIV("saving to localStorage in " + key + " key"); //save to local storage
...
var loadSettings = function loadSettings(key) {
...
function setupSVG() {
  var camCanvas = Storage.camCanvas; // load the SVGcdn to var

  var svgCDN = "http://www.w3.org/2000/svg"; //SVG setup for later viz.
...
function svgCircle(dstPt, fillCol, size, fillOp, strkCol, strkWidth) {
  var svgCDN = "http://www.w3.org/2000/svg"; //display with SVG
...
function loadImg(src, width, height, classname) {
  var img = document.createElement("img");
  img.src = src;
  img.width = width;
  img.height = height;
  img.className = classname; // This next line will just add it to the <body> tag
...
function setupWebCamCanvas() {
  ...
  camCanvas.className = "webcamCanvas"; //MUST keep full numbers [WIP]
...
function setupWebcam() {
  var camCanvas = setupWebCamCanvas(); //store webcam canvas into class

  Storage.camCanvas = camCanvas; //get main canvas context for scanning

  var vidCanvas2dContext = camCanvas.getContext("2d"); //Video loop setup call video mesh creator

  var width = 0;
  var height = 0;
  var video = document.createElement("video"); //set auto play for video

  video.setAttribute("autoplay", true);
  video.addEventListener("loadedmetadata", function () {
    width = camCanvas.width;
    height = camCanvas.height; //call the video to canvas loop
  ...
  function loop() {
    vidCanvas2dContext.drawImage(video, 0, 0, width, height); //loop the video to canvas method
...
function makeInfoDIV() {
  ...
  var bool = false; //listen to clicks

  infoDIV.addEventListener("click", function () {
    if (bool) {
      infoDIV.style.height = "20vw";
      infoDIV.style.width = "20vw"; // infoDIV.innerHTML = "";
    } else {
      infoDIV.style.height = "20vw";
      infoDIV.style.width = "2vw"; // infoDIV.innerHTML = "";
    }
...
var cityIOtimer; ///compare this to new cityIO string to avoid useless POST
...
function cityIOstop() {
  clearInterval(cityIOtimer); // updateInfoDIV("Stopped cityIO POST");
...
function mirrorGrid(typesArray) {
  var cols = Storage.cityIOdataStruct.header.spatial.ncols;
  var mirroredArray = [];

  for (var i = 0; i < typesArray.length; i = i + cols) {
    mirroredArray = mirroredArray.concat(typesArray.slice(i, i + cols).reverse());
  }
...
function cityIOpost() {
  if (Storage.typesArray) {
    ...
    var tempArr = Storage.typesArray; //reverse the grid to fit comply with APIv2

    var typesArray = mirrorGrid(tempArr); //test oldTypesArrayStr for new data, else don't send
    ...
    var cityIOpacket = JSON.parse(JSON.stringify(Storage.cityIOdataStruct)); //get the grid property from the scanner

    cityIOpacket.grid = typesArray; //remove brick codes from sent packet

    delete cityIOpacket.objects.codes; //get table name from settings

    var cityIOtableName = cityIOpacket.header.name;
    var cityIOtableUrl = "https://cityio.media.mit.edu/api/table/update/" + cityIOtableName.toString(); //send to cityIO
    ...
    // )
      ...
      return updateInfoDIV(error);
    });
  } else {
    updateInfoDIV("  CityScopeJS waits for a settings file [.JSON]...  ");
  }
}
},{"./UI/KeyStoneUI":"js/UI/KeyStoneUI.js","./CV/MatrixTransform":"js/CV/MatrixTransform.js","./Storage":"js/Storage.js"}],"node_modules/dat.gui/build/dat.gui.module.js":[function(require,module,exports) {
"use strict";
...
var _default = index;
exports.default = _default;
},{}],"js/UI/RenderGrid.js":[function(require,module,exports) {
"use strict";
...
function renderGrid(state) {
  ...
  function render() {
    ...
    for (var i = 0; i < pixelColArr.length; i++) {
      var pixType = typesArray[Math.floor(i / 16)];
  ...
  function stopRender() {
    ...
    cancelAnimationFrame(Storage.renderAnimFrame); //get the array for pnts + pixel colors

    var svgPntsArray = Storage.svgPntsArray;
    var pixelColArr = Storage.pixelColArr; //delete all and clear visuals
...
},{"../Storage":"js/Storage.js"}],"js/UI/DATGUI.js":[function(require,module,exports) {
"use strict";
...
var _RenderGrid = require("./RenderGrid");
...
function datGUI() {
  ...
  var parm = {
    ...
    getJson: function getJson() {
      var fileClick = document.getElementById("my_file");
      fileClick.click(); //do somthing with the file

      fileClick.onchange = function (e) {
        (0, _Modules.onFileLoad)(e);
      };
    },
    sendRate: 1000,
    //test on cityIO
    ...
    rawCityIO: function rawCityIO() {
      var cityIOdataStruct = Storage.cityIOdataStruct;
      window.open("https://cityio.media.mit.edu/api/table/" + cityIOdataStruct.header.name, "_blank");
    },
    reset: function reset() {
      //clear local memory of last key stone
      localStorage.clear();
      (0, _Modules.updateInfoDIV)("clearing and reseting");
      location.reload(true);
    }
  }; //upload settings

  gui.add(parm, "getJson").name("Start here: Load settings [JSON]"); //or reset and restart

  gui.add(parm, "reset").name("Reset and clear Keystone"); //toggle global_boolean on camera

  gui.add(parm, "global_boolean").name("Toggle Grid Render").onChange(function (state) {
    (0, _RenderGrid.renderGrid)(state);
  }); //toggle global_boolean on camera

  gui.add(parm, "global_boolean").name("Toggle Webcam Video").onChange(function (state) {
    if (!state) {
  ...
  var cityioFolder = gui.addFolder("cityIO"); //cityio send rate

  cityioFolder.add(parm, "sendRate", 250, 2000).step(250).name("cityIO send [ms]").onChange(function (result) {
    (0, _Modules.cityIOstop)();
    (0, _Modules.cityIOinit)(result);
  }); //cityIO link

  cityioFolder.add(parm, "rawCityIO").name("View raw API"); //cityIO link

  cityioFolder.add(parm, "fe").name("View on cityIO Dashboard");
}
},{"dat.gui":"node_modules/dat.gui/build/dat.gui.module.js","../Modules":"js/Modules.js","./RenderGrid":"js/UI/RenderGrid.js","../Storage":"js/Storage.js"}],"media/logo.png":[function(require,module,exports) {
module.exports = "/logo.da61e3ea.png";
...
var _DATGUI = require("./UI/DATGUI");

var logo = _interopRequireWildcard(require("../media/logo.png"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            */
            //create the info div
            (0, _Modules.makeInfoDIV)();
            (0, _Modules.updateInfoDIV)("Starting CityScopeJS applet..."); //make the stats applet

            (0, _Modules.stats)(); //UI menu

            (0, _DATGUI.datGUI)(); //load CS logo

            (0, _Modules.loadImg)(logo.default, 60, 60, "logo"); //setup and start webcam

            (0, _Modules.setupWebcam)(); //make the UI

            (0, _Modules.setupSVG)(); // [WIP] POST to cityIO rate in MS

            sendRate = 1000; //make sure to clear CityIO sending before

            (0, _Modules.cityIOstop)();
            (0, _Modules.updateInfoDIV)("starting cityIO"); //start sending to cityIO

            (0, _Modules.cityIOinit)(sendRate); //after that, check if cityIOdataStruct is already loaded before
            //so we can skip the JSON file selection UI

            if ((0, _Modules.loadSettings)("CityScopeJS_cityIOdataStruct")) {
              Storage.cityIOdataStruct = (0, _Modules.loadSettings)("CityScopeJS_cityIOdataStruct"); // start app sequence

              (0, _Modules.initSequence)();
            }
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./Modules":"js/Modules.js","./UI/DATGUI":"js/UI/DATGUI.js","../media/logo.png":"media/logo.png","./Storage":"js/Storage.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
